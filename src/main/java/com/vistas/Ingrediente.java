...
import com.procedimientos.ProcedimientoMedicionIngrediente;
import com.vistas.agregar.CU_Ingrediente;
...
public class Ingrediente extends javax.swing.JPanel {
     ...
     * @param database
     */
    public Ingrediente(Database database) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButtonMedicion = new javax.swing.JButton();
        ...
        jButtonMedicion.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jButtonMedicion.setText("Modificar mediciones de ingrediente");
        jButtonMedicion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonMedicionMouseClicked(evt);
            }
        });
        ...
        fondoLayout.setHorizontalGroup(
            ...
            .addGroup(fondoLayout.createSequentialGroup()
                ...
                .addGroup(fondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButtonMedicion, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(fondoLayout.createSequentialGroup()
        ...
        fondoLayout.setVerticalGroup(
            ...
            .addGroup(fondoLayout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addComponent(jButtonMedicion, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(21, 21, 21))
        );
    ...
    private void jButtonObtenerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonObtenerMouseClicked
        final String sql = "SELECT * FROM ingredient ORDER BY ingredient_id";
    ...
    private void jButtonAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAgregarMouseClicked
        Dashboard.setContenido(new CU_Ingrediente(database,null));
    ...
    private void jButtonMedicionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonMedicionMouseClicked
        int indice = jTable.getSelectedRow();
        FilaTabla fila = indice != -1 ? new FilaTabla(jTable.getModel(),jTable.getSelectedRow()) : null;
        Dashboard.setContenido(new ProcedimientoMedicionIngrediente(database, fila, null));
    }//GEN-LAST:event_jButtonMedicionMouseClicked
    ...
    private void jButtonEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEditarMouseClicked
        ...
        Dashboard.setContenido(new CU_Ingrediente(database,fila));
        // TODO add your handling code here:
    ...
    private javax.swing.JButton jButtonMedicion;
