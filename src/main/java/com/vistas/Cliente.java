...
public class Cliente extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButtonClasificacion.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jButtonClasificacion.setText("Modificar clasificación del cliente");
        jButtonClasificacion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonClasificacionMouseClicked(evt);
            }
        });
