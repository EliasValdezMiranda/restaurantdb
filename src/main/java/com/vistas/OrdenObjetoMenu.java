...
import com.procedimientos.ProcedimientoAgregarOrdenObjetoMenu;
import com.vistas.agregar.CU_Cliente;
import com.vistas.agregar.CU_OrdenObjetoMenu;
 ...
 * @author Elias
 */
public class OrdenObjetoMenu extends javax.swing.JPanel {
     ...
     * @param database
     */
    public OrdenObjetoMenu(Database database) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Orden de objeto del menú");
        ...
        fondoLayout.setHorizontalGroup(
            ...
            .addGroup(fondoLayout.createSequentialGroup()
                ...
                .addGroup(fondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(fondoLayout.createSequentialGroup()
                        .addComponent(jLabelTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 457, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonObtenerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonObtenerMouseClicked
        final String sql = "SELECT * FROM order_menu_item ORDER BY order_id";
    ...
    private void jButtonAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAgregarMouseClicked
        Dashboard.setContenido(new CU_OrdenObjetoMenu(database,null));
    ...
    private void jButtonEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEliminarMouseClicked
        ...
        for(int i : filas) {
            try {
                ...
                statement.setString(2, modelo.getValueAt(i, 1).toString());
    ...
    private void jButtonEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEditarMouseClicked
        ...
        Dashboard.setContenido(new CU_OrdenObjetoMenu(database,fila));
