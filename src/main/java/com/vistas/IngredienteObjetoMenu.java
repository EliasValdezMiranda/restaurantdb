...
import com.vistas.agregar.CU_IngredienteObjetoMenu;
 ...
 * @author Elias
 */
public class IngredienteObjetoMenu extends javax.swing.JPanel {
     ...
     * @param database
     */
    public IngredienteObjetoMenu(Database database) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Ingrediente de objeto del menú");
        ...
        fondoLayout.setHorizontalGroup(
            ...
            .addGroup(fondoLayout.createSequentialGroup()
                ...
                .addGroup(fondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(fondoLayout.createSequentialGroup()
                        .addComponent(jLabelTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 432, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        fondoLayout.setVerticalGroup(
            ...
            .addGroup(fondoLayout.createSequentialGroup()
                ...
                .addComponent(jScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 356, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void jButtonObtenerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonObtenerMouseClicked
        final String sql = "SELECT * FROM menu_item_ingredient ORDER BY menu_item_id";
    ...
    private void jButtonAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAgregarMouseClicked
        Dashboard.setContenido(new CU_IngredienteObjetoMenu(database,null));
    ...
    private void jButtonEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEliminarMouseClicked
        ...
        for(int i : filas) {
            try {
                ...
                statement.setBigDecimal(1, new BigDecimal(modelo.getValueAt(i, 0).toString()));
    ...
    private void jButtonEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEditarMouseClicked
        ...
        Dashboard.setContenido(new CU_IngredienteObjetoMenu(database,fila));
        // TODO add your handling code here:
