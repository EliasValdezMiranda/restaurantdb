 ...
 * @author Elias
 */
public class ObjetoMenu extends javax.swing.JPanel {
     ...
     * @param database
     */
    public ObjetoMenu(Database database) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Objeto del menú");
        ...
        jButtonIngredientes.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jButtonIngredientes.setText("Administrar Ingredientes");
        jButtonIngredientes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonIngredientesMouseClicked(evt);
            }
        });
        ...
        fondoLayout.setHorizontalGroup(
            ...
            .addGroup(fondoLayout.createSequentialGroup()
                ...
                .addGroup(fondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButtonIngredientes, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(fondoLayout.createSequentialGroup()
        ...
        fondoLayout.setVerticalGroup(
            ...
            .addGroup(fondoLayout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addComponent(jButtonIngredientes, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(21, 21, 21))
        );
    ...
    private void jButtonObtenerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonObtenerMouseClicked
        final String sql = "SELECT * FROM menu_item ORDER BY menu_item_id";
    ...
    private void jButtonAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAgregarMouseClicked
        Dashboard.setContenido(new CU_ObjetoMenu(database,null));
    ...
    private void jButtonIngredientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonIngredientesMouseClicked
        int indice = jTable.getSelectedRow();
        FilaTabla fila = indice != -1 ? new FilaTabla(jTable.getModel(),jTable.getSelectedRow()) : null;
        // TODO Agregar controles para abrir la vista de acuerdo a la fila seleccionada.
        Dashboard.setContenido(new ProcedimientoIngredientesObjetoMenu(database, fila, null));
    }//GEN-LAST:event_jButtonIngredientesMouseClicked
    ...
    private void jButtonEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEditarMouseClicked
        ...
        Dashboard.setContenido(new CU_ObjetoMenu(database,fila));
