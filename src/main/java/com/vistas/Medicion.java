...
import com.vistas.agregar.CU_Medicion;
 ...
 * @author Elias
 */
public class Medicion extends javax.swing.JPanel {
     ...
     * @param database
     */
    public Medicion(Database database) {
        initComponents();
    ...
    private void jButtonObtenerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonObtenerMouseClicked
        final String sql = "SELECT * FROM measurement ORDER BY measurement_id";
    ...
    private void jButtonAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAgregarMouseClicked
        Dashboard.setContenido(new CU_Medicion(database,null));
    ...
    private void jButtonEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEditarMouseClicked
        ...
        Dashboard.setContenido(new CU_Medicion(database,fila));
        // TODO add your handling code here:
