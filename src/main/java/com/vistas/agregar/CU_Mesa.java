 ...
 * @author andr3
 */
public class CU_Mesa extends javax.swing.JPanel {
     ...
     * @param fila
     */
    public CU_Mesa(Database database, FilaTabla fila) {
        if (fila != null) {
            this.fila = fila;
            _editado = true;
        }
        ...
        if (_editado) {
            jTextFieldAsientos.setText(fila.getValue(1).toString());
            jTextFieldPrecio.setText(fila.getValue(2).toString());
            jLabelTitulo.setText("Editar Mesa");
        }
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Agregar Mesa");

        jTextFieldAsientos.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
            ...
            .addGroup(FondoLayout.createSequentialGroup()
                ...
                .addGroup(FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, FondoLayout.createSequentialGroup()
                        .addComponent(jTextFieldAsientos)
                        .addContainerGap())
                    .addGroup(FondoLayout.createSequentialGroup()
                        .addGroup(FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        FondoLayout.setVerticalGroup(
            ...
            .addGroup(FondoLayout.createSequentialGroup()
                ...
                .addComponent(jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextFieldAsientos, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(112, 112, 112)
                .addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButtonCancelarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonCancelarMouseClicked
        Dashboard.setContenido(new Mesa(database));
    ...
    private void agregarFila(){
        String sql = "INSERT INTO \"table\"(table_seats_number, table_price) VALUES (?, ?::money);";
        try {
                database.empezarTransaccion();
                PreparedStatement statement = database.con.prepareStatement(sql);
                statement.setInt(1, Integer.parseInt(jTextFieldAsientos.getText()));
    ...
    private void editarFila() {
        String sql = "UPDATE \"table\" SET table_seats_number=?, table_price=?::money WHERE table_number = ?;";
        try {
                database.empezarTransaccion();
                PreparedStatement statement = database.con.prepareStatement(sql);
                statement.setInt(1, Integer.parseInt(jTextFieldAsientos.getText()));
