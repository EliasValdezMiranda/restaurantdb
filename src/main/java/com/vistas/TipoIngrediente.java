...
import com.vistas.agregar.CU_TipoIngrediente;
 ...
 * @author Elias
 */
public class TipoIngrediente extends javax.swing.JPanel {
     ...
     * @param database
     */
    public TipoIngrediente(Database database) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Tipo de ingrediente");
        ...
        fondoLayout.setVerticalGroup(
            ...
            .addGroup(fondoLayout.createSequentialGroup()
                ...
                .addComponent(jScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void jButtonObtenerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonObtenerMouseClicked
        final String sql = "SELECT * FROM ingredient_type ORDER BY ingredient_type_code";
    ...
    private void jButtonAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAgregarMouseClicked
        Dashboard.setContenido(new CU_TipoIngrediente(database,null));
    ...
    private void jButtonEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEditarMouseClicked
        ...
        Dashboard.setContenido(new CU_TipoIngrediente(database,fila));
