...
import com.vistas.agregar.CU_MedicionIngrediente;
 ...
 * @author Elias
 */
public class MedicionIngrediente extends javax.swing.JPanel {
     ...
     * @param database
     */
    public MedicionIngrediente(Database database) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Medición de ingrediente");
    ...
    private void jButtonObtenerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonObtenerMouseClicked
        final String sql = "SELECT * FROM ingredient_measurement ORDER BY ingredient_id";
    ...
    private void jButtonAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAgregarMouseClicked
        Dashboard.setContenido(new CU_MedicionIngrediente(database,null));
    ...
    private void jButtonEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEditarMouseClicked
        ...
        Dashboard.setContenido(new CU_MedicionIngrediente(database,fila));
        // TODO add your handling code here:
